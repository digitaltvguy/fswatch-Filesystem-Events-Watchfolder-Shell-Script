...
# Attempt to get included extensions into a variable
# Filter trigger files by extension and separate with a pipe (i.e. mov\|mxf)
#FileExtensionFilter=--include '.*\.[mov|mxf]'
...
# Attempt to get included extensions into a variable
#FileIncludeExpression="-e ".*" --include '.*\.[$FileExtensionFilter]'"
